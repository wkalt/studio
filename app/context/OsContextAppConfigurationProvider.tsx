...
// fixme - move this to renderer - this app configuration provider is specific to using preload stuff
// we could even have preload expose different "contexts" for it
